                ...
                if score > 0.5:
                    if class_name == 'zona':
                        ...
                        if time_diff < closest:
                            ...
                            closest_image = image
                            closest_size = size
        if last_size > closest_size:
            final_image = last_image
        else:
            final_image = closest_image
        
        new_dir = "/data/embryo/method_1_day_6"
        old_path = os.path.join(dir, final_image)
        new_path = os.path.join(new_dir, final_image)
