...
callbacks = [
    ...
    TensorBoard(log_dir= '/data/embryo/method_2/grade/final_second_grade')
]
...
history = model.fit_generator(
    ...
    validation_steps = 76//16
)

predicted_classes = model.predict_generator(validation_generator, steps=76//16+1)
...
model.save('/data/embryo/method_2/grade/saved_model/second_grade')