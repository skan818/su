...
callbacks = [
    ...
    TensorBoard(log_dir= '/data/embryo/method_3/grade/final_second_grade')
]
...
history = model.fit_generator(
    train_generator,
    steps_per_epoch=303//32,
    epochs= 500,
    verbose=1,
    callbacks= callbacks,
    validation_data= validation_generator,
    validation_steps = 77//16
)

predicted_classes = model.predict_generator(validation_generator, steps=77//16+1)
...
model.save('/data/embryo/method_3/grade/saved_model/second_grade')