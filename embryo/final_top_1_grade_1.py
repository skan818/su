...
callbacks = [
    ...
    TensorBoard(log_dir= '/data/embryo/method_1/grade/final_top_1_grade')
]
...
predicted_classes = model.predict_generator(validation_generator, steps=80//8+1)
...
model.save('/data/embryo/method_1/grade/saved_model/top_1_grade')