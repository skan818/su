...
callbacks = [
    ...
    TensorBoard(log_dir= '/data/embryo/method_2/grade/final_top_1_grade')
]
...
predicted_classes = model.predict_generator(validation_generator, steps=76//8+1)
...
model.save('/data/embryo/method_2/grade/saved_model/top_1_grade')