...
with tf.summary.create_file_writer('/data/embryo/method_2/grade/hp_first_grade').as_default():
  hp.hparams_config(
...
def train_first_grade(hparams):
    ...
    callbacks = [
        ...
        ModelCheckpoint('/data/embryo/method_2/grade/checkpoints/hp_first_grade.tf',
    ...
    for learning_rate in HP_LR.domain.values:
        for batch_size_1 in HP_BATCH_SIZE_1.domain.values:
            for batch_size_2 in HP_BATCH_SIZE_2.domain.values:
                ...
                run('/data/embryo/method_2/grade/hp_first_grade/' + run_name, hparams)
                session_num += 1