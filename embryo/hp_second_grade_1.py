...
with tf.summary.create_file_writer('/data/embryo/method_1/grade/hp_second_grade').as_default():
  hp.hparams_config(
...
def train_first_grade(hparams):
    ...
    callbacks = [
        ...
        ModelCheckpoint('/data/embryo/method_1/grade/checkpoints/hp_second_grade.tf',
    ...
    for learning_rate in HP_LR.domain.values:
        for batch_size_1 in HP_BATCH_SIZE_1.domain.values:
            for batch_size_2 in HP_BATCH_SIZE_2.domain.values:
                ...
                run('/data/embryo/method_1/grade/hp_second_grade/' + run_name, hparams)
                session_num += 1