...
callbacks = [
    ...
    ModelCheckpoint('/data/embryo/method_1/grade/checkpoints/data_aug.tf',
                    verbose=1, save_weights_only=True, save_best_only=True, monitor='val_top_2_accuracy'),
    TensorBoard(log_dir= '/data/embryo/method_1/grade/data_aug')
]
...
model.save('/data/embryo/method_1/grade/saved_model/pred_grade')
_, accuracy = model.evaluate_generator(
    validation_generator,
    steps = 10)

print("val acc: ",accuracy)
print("top 2 acc: "), history.history['top_2_accuracy']